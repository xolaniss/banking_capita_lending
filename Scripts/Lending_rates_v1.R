...
lending_rate <- c(lending_rate_08_15, lending_rate_15_22)
...
# Export ---------------------------------------------------------------
artifacts_lending_rates_v1 <- list (
  data = list(
...
write_rds(artifacts_lending_rates_v1, file = here("Outputs", "artifacts_lending_rates_v1.rds"))
